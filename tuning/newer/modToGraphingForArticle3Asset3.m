In[239]:= (* GRAPHING *)
    ...
    In[241]:= powerMean[l_, power_] := If[
      power == \[Infinity],
      Max[l],
      Power[Mean[Power[l, power]], 1 / power]
    ];

In[243]:= nestedGraphTuningDamage[unparsedT_, tuningSchemeSpec_, whichOne_] := Module[
  {
    t,
...
In[246]:= graphTuningDamage[unparsedT_, tuningSchemeSpec_] :=Show[
