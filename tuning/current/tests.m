...
(* sensi *)
(* sensamagic *)
testClose[optimizeGeneratorsTuningMap, dual[{{quotientToPcv[32805 / 32768]}, "contra"}], "unchanged-octave diamond minisos-U", {1200.000, 1200.000 + 701.728}]; (* [2b] has a bunch of least squares tunings... only this one works,though; not sure what's up with the rest*)
...
accuracy = 2;
testClose[optimizeTuningMap, meantone, "minimax-lol-ES", {1200.0000, 1896.6516, 2786.6064}]; (* [4]; [1a] has {1200, 1896.651, 2786.605} *)
testClose[optimizeTuningMap, blackwood, "minimax-lol-ES", {1200.0000, 1920.0000, 2795.1253}]; (* [4]; [1a] has {1200, 1920, 2795.126} *)
