...
checkKeesIsPotopConjecture[t_] := Module[{keesTuning, topTuning},
  keesTuning = optimizeGtm[t, "mean" -> "MAV", "weighted" -> True, "complexityWeighting" -> "kees", "tim" -> {}];
  topTuning = optimizeGtm[t, "tuning" -> "Tenney"];
...
checkSopfrIsBopConjecture[t_] := Module[{sopfrTuning, bopTuning},
  ...
  bopTuning = optimizeGtm[t, "mean" -> "MAV", "weighted" -> True, "complexityWeighting" -> "bop", "tim" -> {}];
